...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
   ...
   * @param sslEngineSource the {@link SslEngineSource} for client-to-proxy encryption, or
   *     {@code null} if SSL is not enabled
   * @param authenticateClients whether to require client certificate authentication
   */
  private void initChannelPipeline(ChannelPipeline pipeline, @Nullable SslEngineSource sslEngineSource, boolean authenticateClients) {
