...
public final class PoolConfigUtils {
   ...
   * @throws IllegalArgumentException if the value is not a number or a numeric string
   */
   ...
   * @throws IllegalArgumentException if the value is not a boolean or a boolean string
   */
