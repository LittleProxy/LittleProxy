...
/**
 * Represents a regex-based response header field that matches headers by pattern.
 * This class discovers and logs all response headers matching a given regex pattern.
 */
public class RegexResponseHeaderField implements LogField {
    ...
    /**
     * Creates a new regex-based response header field.
    ...
    /**
     * Creates a new regex-based response header field with custom field name transformation.
     * @param pattern the regex pattern to match
     * @param fieldNameTransformer function to transform header names to field names
     */
    public RegexResponseHeaderField(Pattern pattern, Function<String, String> fieldNameTransformer) {
        this(pattern, fieldNameTransformer, value -> value);
    }

    /**
     * Creates a new regex-based response header field with custom field name and value transformation.
     * @param pattern the regex pattern to match
     * @param fieldNameTransformer function to transform header names to field names
    ...
    /**
     * Creates a new regex-based response header field from a regex string.
    ...
    /**
     * Creates a new regex-based response header field from a regex string with custom transformer.
     * @param regex the regex pattern string to match
     * @param fieldNameTransformer function to transform header names to field names
     */
    ...
    /**
     * Creates a new regex-based response header field from a regex string with custom field name and value transformation.
     * @param regex the regex pattern string to match
     * @param fieldNameTransformer function to transform header names to field names
     * @param valueTransformer function to transform header values
     */
    ...
    public String getName() {
        return "resp_" + pattern.pattern().toLowerCase().replaceAll("[^a-z0-9]", "_") + "*";
    }
    ...
    public String toString() {
        return "RegexResponseHeaderField{pattern='" + pattern.pattern() + "'}";
    }
}
