...
/**
 * Represents a regex-based request header field that matches headers by pattern. This class
 * discovers and logs all request headers matching a given regex pattern.
 */
public class RegexRequestHeaderField implements LogField {
   ...
   */
  public RegexRequestHeaderField(
      Pattern pattern,
  ...
  /**
   * Creates a new regex-based request header field from a regex string with custom field name and
