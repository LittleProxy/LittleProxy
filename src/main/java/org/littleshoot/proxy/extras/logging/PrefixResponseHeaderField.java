...
/**
 * Represents a pattern-based response header field that matches headers by prefix. This class
 * discovers and logs all response headers starting with a given prefix.
 */
public class PrefixResponseHeaderField implements LogField {
  ...
  /**
   * Creates a new prefix-based response header field with custom field name and value
   * transformation.
   *
   * @param prefix the prefix to match (e.g., "X-RateLimit-")
   * @param fieldNameTransformer function to transform header names to field names
   ...
   */
  public PrefixResponseHeaderField(
      String prefix,
