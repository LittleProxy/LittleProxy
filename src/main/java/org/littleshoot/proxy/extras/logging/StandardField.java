...
/**
 * Enumeration of standard log fields that are commonly used in HTTP access logs.
 * These fields have predefined extraction logic and represent the most common
 * logging data points.
 */
