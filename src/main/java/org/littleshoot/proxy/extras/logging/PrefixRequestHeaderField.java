...
/**
 * Represents a pattern-based request header field that matches headers by prefix. This class
 * discovers and logs all request headers starting with a given prefix.
 */
public class PrefixRequestHeaderField implements LogField {
  ...
  public PrefixRequestHeaderField(String prefix) {
    this(prefix, PrefixRequestHeaderField::defaultFieldName, value -> value);
  }
  ...
  /**
   * Creates a new prefix-based request header field with custom field name and value
   * transformation.
   *
   * @param prefix the prefix to match (e.g., "X-Custom-")
   * @param fieldNameTransformer function to transform header names to field names
   ...
   */
  public PrefixRequestHeaderField(
      String prefix,
    ...
    this.fieldNameTransformer =
        fieldNameTransformer != null
            ...
            : PrefixRequestHeaderField::defaultFieldName;
