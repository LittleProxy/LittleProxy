...
/**
 * Configuration class that defines which fields should be logged by ActivityLogger. This class uses
 * the builder pattern to provide a fluent API for configuring log fields with fine-grained control.
 */
public class LogFieldConfiguration {
  ...
  public static LogFieldConfiguration defaultConfig() {
    return builder().addStandardFields().strictStandardsCompliance(false).build();
  }
  ...
  public static class Builder {
     ...
     * @return this builder for chaining
     */
    public Builder addRequestHeadersWithPrefix(
        String prefix, java.util.function.Function<String, String> fieldNameTransformer) {
     ...
     * @return this builder for chaining
     */
    public Builder addResponseHeadersWithPrefix(
        String prefix, java.util.function.Function<String, String> fieldNameTransformer) {
     ...
     * @return this builder for chaining
     */
    public Builder addRequestHeadersMatching(
        String regexPattern, java.util.function.Function<String, String> fieldNameTransformer) {
     ...
     * @return this builder for chaining
     */
    public Builder addResponseHeadersMatching(
        String regexPattern, java.util.function.Function<String, String> fieldNameTransformer) {
    ...
    /**
     * Adds all request headers matching a regex pattern with custom field name and value
     * transformation.
     *
     * @param regexPattern the regex pattern to match
     * @param fieldNameTransformer function to transform header names to field names
    ...
    /**
     * Adds all response headers matching a regex pattern with custom field name and value
     * transformation.
     *
     * @param regexPattern the regex pattern to match
     * @param fieldNameTransformer function to transform header names to field names
    ...
    public Builder addResponseHeadersMatching(
        ...
        java.util.function.Function<String, String> valueTransformer) {
      fields.add(
          new RegexResponseHeaderField(regexPattern, fieldNameTransformer, valueTransformer));
      return this;
    }
     ...
     * @return this builder for chaining
     */
    public Builder excludeRequestHeadersMatching(
        String excludePattern,
        java.util.function.Function<String, String> fieldNameTransformer,
        java.util.function.Function<String, String> valueTransformer) {
      fields.add(
          new ExcludeRequestHeaderField(excludePattern, fieldNameTransformer, valueTransformer));
      return this;
    }
