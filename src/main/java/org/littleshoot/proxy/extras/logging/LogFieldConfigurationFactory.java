...
/**
 * Factory for creating LogFieldConfiguration from various sources.
 * Supports JSON configuration files and CLI options.
 */
public class LogFieldConfigurationFactory {
    ...
    public static LogFieldConfiguration buildConfiguration(LoggingConfiguration config) {
        ...
        if (config.getPrefixHeaders() != null) {
            for (LoggingConfiguration.PrefixHeaderConfig prefixConfig : config.getPrefixHeaders()) {
                ...
                Function<String, String> fieldNameTransformer = getFieldNameTransformer(
                    prefixConfig.getFieldNameTransformer());
                Function<String, String> valueTransformer = getValueTransformer(
                    prefixConfig.getValueTransformer());
        ...
        if (config.getRegexHeaders() != null) {
            for (LoggingConfiguration.RegexHeaderConfig regexConfig : config.getRegexHeaders()) {
                ...
                Function<String, String> fieldNameTransformer = getFieldNameTransformer(
                    regexConfig.getFieldNameTransformer());
                Function<String, String> valueTransformer = getValueTransformer(
                    regexConfig.getValueTransformer());
        ...
        if (config.getExcludeHeaders() != null) {
            for (LoggingConfiguration.ExcludeHeaderConfig excludeConfig : config.getExcludeHeaders()) {
                ...
                Function<String, String> fieldNameTransformer = getFieldNameTransformer(
                    excludeConfig.getFieldNameTransformer());
                Function<String, String> valueTransformer = getValueTransformer(
                    excludeConfig.getValueTransformer());
    ...
    /**
     * Creates a basic LogFieldConfiguration with just standard fields.
