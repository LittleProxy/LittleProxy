...
/**
 * Represents an exclusion pattern for request headers.
 * This field logs all request headers EXCEPT those matching the given regex pattern.
 * Useful for excluding sensitive headers like Authorization, Cookie, etc.
 */
public class ExcludeRequestHeaderField implements LogField {
    ...
    /**
     * Creates a new exclusion-based request header field.
    ...
    /**
     * Creates a new exclusion-based request header field with custom transformers.
    ...
    /**
     * Creates a new exclusion-based request header field from a regex string.
    ...
    /**
     * Creates a new exclusion-based request header field from a regex string with custom transformers.
     * @param excludeRegex the regex pattern string for headers to exclude
     * @param fieldNameTransformer function to transform header names to field names
     * @param valueTransformer function to transform header values
     */
    ...
    public String getName() {
        return "req_all_except_" + excludePattern.pattern().toLowerCase().replaceAll("[^a-z0-9]", "_");
    }
    ...
    public String toString() {
        return "ExcludeRequestHeaderField{excludePattern='" + excludePattern.pattern() + "'}";
    }
}
