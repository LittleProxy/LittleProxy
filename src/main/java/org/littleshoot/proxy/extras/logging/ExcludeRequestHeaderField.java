...
/**
 * Represents an exclusion pattern for request headers. This field logs all request headers EXCEPT
 * those matching the given regex pattern. Useful for excluding sensitive headers like
...
public class ExcludeRequestHeaderField implements LogField {
   ...
   */
  public ExcludeRequestHeaderField(
  ...
  /**
   * Creates a new exclusion-based request header field from a regex string with custom
   * transformers.
   *
   * @param excludeRegex the regex pattern string for headers to exclude
   * @param fieldNameTransformer function to transform header names to field names
