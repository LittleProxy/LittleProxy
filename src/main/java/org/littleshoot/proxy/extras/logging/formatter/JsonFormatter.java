 ...
 *
 * <p>Produces structured JSON output with configurable fields. Supports dynamic field extraction
 * including prefix-based header fields, regex-based header fields, and exclusion patterns.
 *
 * <p>Example: {"flow_id":"...","client_ip":"127.0.0.1","method":"GET","status":"200"}
 */
public class JsonFormatter extends AbstractLogEntryFormatter {
