...
/**
 * Represents a regex-based response header field that matches headers by pattern. This class
 * discovers and logs all response headers matching a given regex pattern.
 */
public class RegexResponseHeaderField implements LogField {
  ...
  /**
   * Creates a new regex-based response header field with custom field name and value
   * transformation.
   *
   * @param pattern the regex pattern to match
   * @param fieldNameTransformer function to transform header names to field names
   ...
   */
  public RegexResponseHeaderField(
      Pattern pattern,
  ...
  /**
   * Creates a new regex-based response header field from a regex string with custom field name and
