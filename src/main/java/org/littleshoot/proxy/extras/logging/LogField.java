...
/**
 * Interface for all log fields that can be configured in ActivityLogger. Provides the foundation
 * for different types of log fields including standard fields, header fields, and computed fields.
 */
