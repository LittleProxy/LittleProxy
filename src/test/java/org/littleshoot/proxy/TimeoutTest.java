...
public final class TimeoutTest {
    ...
    public void testIdleConnectionTimeout() throws Exception {
        ...
        mockServer.stubFor(get(urlEqualTo("/idleconnection"))
    ...
    /**
     * Verifies that when the client times out sending the initial request, the
     * proxy still returns a Gateway Timeout.
     */
    @Test
