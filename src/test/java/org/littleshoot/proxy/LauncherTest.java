...
class LauncherTest {
    ...
    void testStartWithMitmOption() {
        // Given
        String[] args = {"--port", "" + port, "--mitm","--ssl_clients_keystore_path","target/littleproxy_keystore.jks"};
    ...
    void testStartWithAuthenticateSslClientsOption() {
        // Given
        String[] args = {"--port", "" + port, "--authenticate_ssl_clients", "true","--ssl_clients_keystore_path","target/littleproxy_keystore.jks"};
    ...
    void testStartWithSslClientsTrustAllServersOption() {
        ...
        String[] args = {"--port", "" + port, "--authenticate_ssl_clients", "true",
                "--ssl_clients_trust_all_servers", "true","--ssl_clients_keystore_path","target/littleproxy_keystore.jks"};
    ...
    void testStartWithSslClientsSendCertsOption() {
        // Given
        String[] args = {"--port", "" + port, "--authenticate_ssl_clients", "true",
                "--ssl_clients_send_certs", "true","--ssl_clients_keystore_path","target/littleproxy_keystore.jks"};
    ...
    void testStartWithMultipleOptions() {
        ...
        String[] args = {"--port", "" + port, "--mitm", "--dnssec", "true",
                "--name", "TestProxy", "--allow_local_only", "true","--ssl_clients_keystore_path","target/littleproxy_keystore.jks"};
