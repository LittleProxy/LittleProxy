...
/**
 * Unit test to verify that Proxy-Authorization headers are properly preserved when forwarding to
...
public class ProxyAuthorizationHeaderPreservationTest {
  ...
  public void testProxyAuthorizationHeaderPreservedWhenNeeded() {
    ...
    System.out.println(
        "After stripping hop-by-hop headers (preserving Proxy-Authorization): "
            + request.headers());
  ...
  public void testProxyAuthorizationHeaderRemovedWhenNotNeeded() {
    ...
    System.out.println(
        "After stripping hop-by-hop headers (not preserving Proxy-Authorization): "
            + request.headers());
