...
public final class MessageTerminationTest {
        ...
        public void testResponseWithoutTerminationIsChunked() throws Exception {
                ...
                HttpResponse response = httpClient
                                .execute(new HttpGet("http://127.0.0.1:" + mockServerPort + "/"));
                ...
                assertThat(transferEncodingHeaders).as("Expected to see a Transfer-Encoding header").isNotEmpty();
        ...
        public void testFilterAddsContentLength() throws Exception {
                ...
                assertThat(contentLengthHeaders).as("Expected to see a Content-Length header")
                                .isNotEmpty();
        ...
        public void testResponseToHEADNotModified() throws Exception {
                ...
                mockServer.stubFor(head(urlEqualTo("/"))
                                .willReturn(aResponse()
                                                .withStatus(200)));
